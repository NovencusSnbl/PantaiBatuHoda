...
<div class="row text-center padding">
	...
	<div class="col-md-3">
		<div class="card">
			<img class="card-img-top"src="img/ban.jpg">
			<div class="card-body">
				<h4 class="card-title">Ban Air</h4>
				<p class="card-text">Rp.5.000 -20.000 untuk 2 jam</p>
			</div>
		</div>
	</div>
</div>
...
<div class="row welcome text-center">
	<div class="col-12">
		<h1 class="display-4">amaRIS Homestay</h1>
	</div>
	<hr>
</div>
<div class="row text-center padding">
	...
	<div class="col-md-3">
		<div class="card">
			<img class="card-img-top"src="img/galartikar.jpg">
			<div class="card-body">
				<h4 class="card-title">Gelar Tikar</h4>
